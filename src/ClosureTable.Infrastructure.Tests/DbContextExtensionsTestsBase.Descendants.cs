...
public abstract partial class DbContextExtensionsTestsBase<TFixture>
{
    ...
    public async Task HasDescendants_OfTestDataEntity_ShouldBeExpected(string entityName, bool expected)
    {
        ...
        var actual = context.HasDescendants<TestEntity, Guid, TestRelationship, TestRelationshipProperties>(entity.Id);
    ...
    public async Task HasDescendantsAsync_OfTestDataEntity_ShouldBeExpected(string entityName, bool expected)
    {
        ...
        // Act
        var actual = await context.HasDescendantsAsync<TestEntity, Guid, TestRelationship, TestRelationshipProperties>(entity.Id);
    ...
    public async Task DescendantsCount_OfTestDataEntity_ShouldBeExpected(string entityName, int expected)
    {
        ...
        // Act
        // ReSharper disable once MethodHasAsyncOverload
        var actual = context.DescendantsCount<TestEntity, Guid, TestRelationship, TestRelationshipProperties>(entity.Id);
    ...
    public async Task DescendantsCountAsync_OfTestDataEntity_ShouldBeExpected(string entityName, int expected)
    {
        ...
        // Act
        var actual = await context.DescendantsCountAsync<TestEntity, Guid, TestRelationship, TestRelationshipProperties>(entity.Id);
        ...
        string[] expectedDescendantNames)
    {
        ...
        var actual = await context
            .DescendantsOf<TestEntity, Guid, TestRelationship, TestRelationshipProperties>(entity.Id, withSelf)
            .ToListAsync();
